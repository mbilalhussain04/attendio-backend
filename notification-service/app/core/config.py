...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_file=(SERVICES_DIR / ".env", SERVICE_DIR / ".env", SERVICES_DIR / ".env.local", SERVICE_DIR / ".env.local"), case_sensitive=True, extra="ignore")
